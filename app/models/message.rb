...
class Message < ActiveRecord::Base
  ...
  def emoticon
    { "autumn" => "emoticons/autumn.png",
      ...
      "awesome" => "emoticons/good.png",
      "good-luck" => "emoticons/good.png",
      "thumb" => "emoticons/good.png",
      "hallelujah" => "emoticons/hallelujah.png",
      "magic" => "emoticons/hallelujah.png",
      "wizard" => "emoticons/hallelujah.png",
      "laugh" => "emoticons/laugh.png",
      "haha" => "emoticons/laugh.png",
      "funny" => "emoticons/laugh.png",
      "laughing" => "emoticons/laugh.png",
      "name" => "emoticons/name.png",
      "what-is-your-name" => "emoticons/name.png",
      "my-name" => "emoticons/name.png",
      "introduce" => "emoticons/name.png",
      ...
      "fight" => "emoticons/punch.png",
      "fighting" => "emoticons/punch.png",
      "boxing" => "emoticons/punch.png",
      ...
      "shopperholic" => "emoticons/shopping.png",
      "boxing-day" => "emoticons/shopping.png",
      "department-store" => "emoticons/shopping.png",
      "shopping centre" => "emoticons/shopping.png",
